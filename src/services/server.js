...
app.get("/sensors/api", (req, res) => {
  res.json({
    sensors: [
      {
        name: "sensor_1",
        distance: distances.sensor_1.distance,
        isSitTaken: distances.sensor_1.isSitTaken,
      },
      {
        name: "sensor_2",
        distance: distances.sensor_2.distance,
        isSitTaken: distances.sensor_2.isSitTaken,
      },
      {
        name: "sensor_3",
        distance: distances.sensor_3.distance,
        isSitTaken: distances.sensor_3.isSitTaken,
      },
      {
        name: "sensor_4",
        distance: distances.sensor_4.distance,
        isSitTaken: distances.sensor_4.isSitTaken,
      },
    ],
  });
});
...
app.post("/calibration", (req, res) => {
  ...
  console.log(
    `Received calibration data - Minimum Distance: ${minDistance}, Selected Port: ${port}`
  );
  portName = port;
